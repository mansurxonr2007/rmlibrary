...
class Students(models.Model):
    ...
    def __str__(self):
        return str(f"{self.sinf} - {self.first_name}{' '+self.middle_name if not self.middle_name == '' else ''} {self.last_name}")
...
class Borrow(models.Model):
    ...
    def __str__(self):
        return str(f"{self.student.sinf}")
