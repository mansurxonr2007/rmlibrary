...
def save_register(request):
    ...
    if not request.method == 'POST':
        resp['msg'] = "Sizning so'rovingizga ma'lumot topilmadi!"
    else:
        form = forms.SaveUser(request.POST)
        if form.is_valid():
            form.save()
            messages.success(request, "Sizning akkountingiz yaratildi")
            resp['status'] = 'success'
        else:
            for field in form:
...
def update_profile(request):
    context = context_data(request)
    context['page_title'] = 'Profileni yangilash'
...
def update_password(request):
    context =context_data(request)
    context['page_title'] = "Parolni Yangilash"
    if request.method == 'POST':
        form = forms.UpdatePasswords(user = request.user, data= request.POST)
        if form.is_valid():
            form.save()
            messages.success(request,"Akkountingiz paroli yangilandi")
    ...
    if request.POST:
        ...
        if user is not None:
            if user.is_active:
                ...
                resp['msg'] = "Login yoki Parol xato !"
        else:
            resp['msg'] = "Login yoki Parol xato !"
    return HttpResponse(json.dumps(resp),content_type='application/json')
...
def save_user(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
         ...
         resp['msg'] = "Sizining so'rovingiz uchun hech narsa topilmadi!"
...
def manage_user(request, pk = None):
    ...
    context['page_title'] = 'Foydalanuvchilarni Boshqarish'
    if pk is None:
        context['user'] = {}
    else:
...
def delete_user(request, pk = None):
    ...
    if pk is None:
        ...
        try:
            ...
            resp['msg'] = "Foydalanuvchi O'chirishda Xatolik!"
...
def category(request):
    ...
    context['page_title'] = "Kategoriyalar Ro'yxati"
...
def save_category(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            form.save()
            if post['id'] == '':
                messages.success(request, "Kategoriya Muvaffaqiyatli saqlandi !")
            else:
...
def view_category(request, pk = None):
    ...
    context['page_title'] = "Kategoriyalarni Ko'rish"
    if pk is None:
        context['category'] = {}
    else:
...
def manage_category(request, pk = None):
    ...
    context['page_title'] = 'Kategoriyalarni Boshqarish'
    if pk is None:
        context['category'] = {}
    else:
        context['category'] = models.Category.objects.get(id=pk)
...
def sub_category(request):
    ...
    context['page_title'] = "2-Kategoriyalar Ro'yxati"
...
def save_sub_category(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            form.save()
            if post['id'] == '':
                messages.success(request, "2-Kategoriya saqlandi")
            else:
                messages.success(request, "2-Kategoriya yangilandi")
            resp['status'] = 'success'
        else:
            for field in form:
                for error in field.errors:
         ...
         resp['msg'] = "Hech qanday ma'lumot yo'q"
...
def books(request):
    context = context_data(request)
    context['page'] = 'book'
    context['page_title'] = "Kitoblar Ro'yxati"
...
def save_book(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            form.save()
            if post['id'] == '':
                messages.success(request, "Kitob Muvaffaqiyatli saqlandi!")
            else:
         ...
         resp['msg'] = "Hech qanday ma'lumot topilmadi."
...
def view_book(request, pk = None):
    ...
    context['page_title'] = "Kitoblarni Ko'rish"
    if pk is None:
        context['book'] = {}
    else:
...
def manage_book(request, pk = None):
    ...
    context['page_title'] = 'Kitoblarni Boshqarish'
    if pk is None:
        context['book'] = {}
    else:
        context['book'] = models.Books.objects.get(id=pk)
...
def delete_book(request, pk = None):
    ...
    if pk is None:
        ...
        try:
            ...
            messages.success(request, "Kitob o'chirib tashlandi.")
            resp['status'] = 'success'
        except:
            resp['msg'] = "Kitobni o'chirishda xatolik."
...
def students(request):
    ...
    context['page_title'] = "O'quvchilar Ro'yxati."
...
def save_student(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            form.save()
            if post['id'] == '':
                messages.success(request, "Student Muvaffaqiyatli saqlandi")
            else:
...
def save_borrow(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            form.save()
            if post['id'] == '':
                messages.success(request, "Borrowing Transaction Muvaffaqiyatli saqlandi")
            else:
                messages.success(request, "Borrowing Transaction Muvaffaqiyatli yangilandi.")
            resp['status'] = 'success'
        else:
            for field in form:
                for error in field.errors:
